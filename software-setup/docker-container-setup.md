...
We use the `dustynv/ros` docker setup use on the Jetson Nano, running jetpack 4 on Ubuntu 18.04.

The link to the docker container is [here](https://hub.docker.com/r/dustynv/ros/tags).

The link to the github for other packages is [here](https://github.com/dusty-nv/jetson-containers/tree/master/packages/ros).
